...
$lang['get-user-linked-emails']                 = 'SQL Statement to select all linked emails for any given user';
$lang['add-linked-emails']                      = 'SQL Statement to add a new linked email for any given user';
$lang['remove-linked-emails']                   = 'SQL Statement to remove an existing linked email from any given user';
$lang['update-login-time']          = 'SQL Statement to update login time when logged in with password';
$lang['update-login-time-oauth']    = 'SQL Statement to update login time when logged in with oauth';
