...
class BitBucket extends AbstractService
{
    ...
    {
        return new Uri('https://bitbucket.org/!api/1.0/oauthpdo/request_token');
    }
    ...
    {
        return new Uri('https://bitbucket.org/!api/1.0/oauthpdo/authenticate');
    }
    ...
    {
        return new Uri('https://bitbucket.org/!api/1.0/oauthpdo/access_token');
    }
